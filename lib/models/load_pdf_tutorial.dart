...
class _ViewPdfState extends State<ViewPdf> {
  ...
  void initState() {
    ...
    getFileFromUrl("https://docs.aws.amazon.com/AmazonS3/latest/gsg/s3-gsg.pdf").then((f) {
      setState(() {
        urlPDFPath = f.path;
        print(urlPDFPath);
      });
        ...
        floatingActionButton: Row(
          ...
          children: <Widget>[
            _currentPage > 0
              ...
              label: Icon(Icons.chevron_left, color: Colors.black,),
//              Text("Go to ${_currentPage - 1}"),
              onPressed: () {
                _currentPage -= 1;
